...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LuttyRuo', // 您的昵称 例如 tangly1024Ruo
  BIO: process.env.NEXT_PUBLIC_BIO || '一个喜欢干饭的普通人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.lutty.buzz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'GeoplysicGeoplysic, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'LuttyRuo@outlook.com', // 邮箱地址 例如mail@tangly1024.com
